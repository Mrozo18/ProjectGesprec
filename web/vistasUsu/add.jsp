                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control" name="txtNombreUsu" placeholder="Ingresa nombre de Usuario">
                                                            </div>
                                                            <div class="form-group">
                                                                <label class="form-label">Contraseña</label>
                                                                <input type="text" class="form-control" name="txtContrasena" placeholder="Ingresar contraseña">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label class="form-label">Rol</label>
                                                                <select name="id_Rol" class="form-control custom-select">
                                                                    <option value="0" readonly>Seleccione opción</option>
                                                                    <option value="1">Otro Administrador</option>
